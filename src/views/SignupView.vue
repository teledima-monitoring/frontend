  ...
  <div class="auth-wrapper">
    <div class="auth-card">
      ...
      <div class="text-center mb-4">
        ...
        <p class="text-muted small mb-0">Join us and start managing your projects.</p>
      </div>
      ...
      <form @submit.prevent="handleSignup">
        <!-- Username -->
        <div class="mb-3">
          <label for="signup-login" class="form-label small fw-semibold">Username</label>
        ...
        <!-- Password -->
        <div class="mb-4">
          <label for="signup-password" class="form-label small fw-semibold">Password</label>
          <div class="input-group">
            <span class="input-group-text bg-light border-end-0">
